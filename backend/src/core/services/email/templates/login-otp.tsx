				...
				>
					...
					>
						...
						<Section className="px-8 py-8">
							...
							>
								We received a login attempt for your LOSL-C account. To complete
								your login, please use the one-time password (OTP) below:
							</Text>
							...
							>
								Enter this code in your login screen to access your account. If
								you didn't attempt to log in, please ignore this email and
							...
							>
								...
								>
									Never share this code with anyone. LOSL-C staff will never ask
									for your OTP code. If you didn't request this login, please

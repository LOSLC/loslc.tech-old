        ...
        <div className="space-y-8">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
                  {(t('privacyPolicy.sections.infoCollect.personalItems', { returnObjects: true }) as string[]).map((item, i) => (
                    <li key={i}>{item}</li>
                  ))}
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
                  {(t('privacyPolicy.sections.infoCollect.usageItems', { returnObjects: true }) as string[]).map((item, i) => (
                    <li key={i}>{item}</li>
                  ))}
                </ul>
                <p className="text-muted-foreground mt-2 text-sm">
                  <strong>{t('common.note', { defaultValue: 'Note:' })}</strong> {t('privacyPolicy.sections.infoCollect.note')}
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                {(t('privacyPolicy.sections.howWeUse.items', { returnObjects: true }) as string[]).map((item, i) => (
                  <li key={i}>{item}</li>
                ))}
              </ul>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside text-muted-foreground mt-2 space-y-1">
                  {(t('privacyPolicy.sections.security.securityItems', { returnObjects: true }) as string[]).map((item, i) => (
                    <li key={i}>{item}</li>
                  ))}
                </ul>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                {(t('privacyPolicy.sections.sharing.items', { returnObjects: true }) as string[]).map((item, i) => (
                  <li key={i}>{item}</li>
                ))}
              </ul>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                {(t('privacyPolicy.sections.cookies.items', { returnObjects: true }) as string[]).map((item, i) => (
                  <li key={i}>{item}</li>
                ))}
              </ul>
              <p className="text-muted-foreground mt-4">
                <strong>{t('privacyPolicy.sections.cookies.noteStrong')}</strong>{" "}
          ...
          <Card>
            <CardHeader>
              <CardTitle>{t('privacyPolicy.sections.thirdParty.title')}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground mb-4">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-2">
                {(t('privacyPolicy.sections.thirdParty.items', { returnObjects: true }) as string[]).map((item, i) => (
                  <li key={i}>{item}</li>
                ))}
              </ul>
              <p className="text-muted-foreground mt-4">
                <strong>{t('privacyPolicy.sections.thirdParty.privacyApproachStrong')}</strong> {t('privacyPolicy.sections.thirdParty.privacyApproach')}
              </p>
              <p className="text-muted-foreground mt-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="space-y-2 text-muted-foreground">
                <p>
                  <strong>{t('privacyPolicy.sections.contact.email')}:</strong> privacy@loslc.tech
                </p>
                <p>
                  <strong>{t('privacyPolicy.sections.contact.general')}:</strong> support@loslc.tech
                </p>
                <p>
                  <strong>{t('privacyPolicy.sections.contact.address')}:</strong> {t('privacyPolicy.sections.contact.addressValue')}
                </p>
              </div>
            </CardContent>
          </Card>

...
function ResetPasswordContent() {
	...
	const validateForm = () => {
		...
		if (!formData.verificationToken) {
			newErrors.verificationToken = t("validation.required", {
				field: t("auth.verificationToken"),
			});
		}
				...
				<div className="w-full max-w-md">
					<Card className="shadow-lg">
						<CardHeader className="text-center">
							...
							<CardDescription>{t("auth.resetLinkExpired")}</CardDescription>
						</CardHeader>
			...
			<div className="w-full max-w-md">
				...
				<Card className="shadow-lg">
					<CardHeader className="space-y-1">
						...
						<CardDescription>{t("auth.chooseSecurePassword")}</CardDescription>
					</CardHeader>
						...
						<form onSubmit={handleSubmit} className="space-y-4">
							<div className="space-y-2">
								...
								<Input
									...
									onChange={(e) =>
										updateFormData("verificationToken", e.target.value)
									}

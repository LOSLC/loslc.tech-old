...
export const metadata: Metadata = {
  ...
  keywords: ["Linux", "Open Source", "Cybersecurity", "Africa", "Togo", "Technology", "Community", "Security", "LOSL-C"],
  authors: [{ name: "LOSL-C Community" }],
  creator: "LOSL-C",
  publisher: "LOSL-C",
  openGraph: {
    title: "LOSL-C - Linux, Open-Source & Cybersecurity Community",
    description: "Empowering African developers through Linux, Open-Source, and Cybersecurity education. Join our thriving tech community in Togo and across Africa.",
  ...
  twitter: {
    ...
    title: "LOSL-C - Linux, Open-Source & Cybersecurity Community",
    description: "Empowering African developers through Linux, Open-Source, and Cybersecurity education.",
    images: ["/cover.png"],
  },
  icons: "/favicon.png",
};

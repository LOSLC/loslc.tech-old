...
export function LikeButton({
	...
	const { data: hasLiked = false, isLoading: likeLoading } = useHasLiked(
		postId,
		true,
	);
	...
	return (
		<Button
			...
			variant="ghost"
			aria-label={
				hasLiked ? t("blog.like.ariaUnlike") : t("blog.like.ariaLike")
			}
		...
		>
			<Heart
				className={cn("w-4 h-4", hasLiked && "fill-rose-500 stroke-rose-500")}
			/>

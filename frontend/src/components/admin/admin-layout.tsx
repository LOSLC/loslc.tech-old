              ...
              <HoverCardTrigger asChild>
                <Button
                  ...
                  className={cn(
                    ...
                    isActive && "shadow-lg bg-gradient-to-br from-primary to-primary/90"
                  )}
                  asChild
                >
                  <Link href={item.href}>
          ...
          <HoverCard openDelay={100} closeDelay={0}>
            <HoverCardTrigger asChild>
              ...
              >
                <Link href="/blog">
                  ...
                  <span className="text-xs font-medium text-muted-foreground group-hover:text-destructive transition-colors duration-200">Exit</span>
                </Link>
              </Button>
            </HoverCardTrigger>
            <HoverCardContent 
            ...
            >
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">Return to main website</p>
              </div>
            </HoverCardContent>
          </HoverCard>
        </div>
